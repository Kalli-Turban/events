...
# events_1_6.py
# Frontend mit serverseitiger Suche + Pagination
# Ergänzt: Mindestlänge 2 Zeichen & ❌ Suche löschen
...
__APP_VERSION__ = "Frontend v1.5 (Search + Pagination, minlen+clear)"
...
def format_event_card(event: dict) -> str:
    ...
    md = f"""
### 📌 {titel}
🗓️ {datum}{'  ⏰ ' + uhrzeit if uhrzeit else ''}{' (' + dauer + ')' if dauer else ''}  
{('📍 ' + ort) if (show_location and ort) else ''}{(' | Kategorie: ' + kategorie) if kategorie else ''}
